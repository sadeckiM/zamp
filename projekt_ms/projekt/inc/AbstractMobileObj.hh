    ...
    class AbstractMobileObj {
     public:
        ...
        */
        ...
        virtual const Vector3D & GetRotation() const = 0;
        virtual const Vector3D_int & GetColor() const = 0;
        virtual const Vector3D & GetScale() const = 0;
        virtual void SetColor(const Vector3D_int & col) = 0;
        virtual void SetScale(const Vector3D & sc) = 0;
