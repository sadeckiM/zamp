...
/*!
 * \brief Modeluje polecenie dla robota mobilnego, które zmienia skale jego elementu
 *
 *  Klasa modeluj47e ...
 */
class Interp4Scale: public AbstractInterp4Command {
 ...
 public:
  ...
  void ExecAnim(std::shared_ptr<AbstractMobileObj> pObj, AbstractComChannel &rComChann, 
                Vector3D &startScale, int steps, int delay) const;
