...
namespace gsv {
  ...
  enum GeomObjType  { CuboidType /*! Prostopadłościan */,
		      PrismType /*! Graniastosłup (domyślnie: foremny) */,
		      PyramidType /*! Ostrosłup (domyślnie: foremny) */,
		      SphereType /*! Sfera */,
		      HemisphereType /*! Pólkula */ };
  ...
  class GeomParams {
    protected:
     /*!
      * \brief Type of geometrical object
      */
      WatchedValue<GeomObjType>    _ObjType = CuboidType;
	...
	* Przyjmuje się, że współrzędne wyrażone są w metrach.
      ...
      *
      */
      GeomObjType GetObjType() const { return _ObjType.Get(); }
     /*!
      *
      */
      GeomObjType & UseObjType() { return _ObjType.Use(); }
